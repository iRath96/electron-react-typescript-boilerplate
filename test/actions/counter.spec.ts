...
describe('actions', () => {
  it('should increment should create increment action', () => {
    expect(actions.increment()).to.deep.equal({ type: actions.increment.type });
  });

  it('should decrement should create decrement action', () => {
    expect(actions.decrement()).to.deep.equal({ type: actions.decrement.type });
  });
  ...
  it('should incrementIfOdd should create increment action', () => {
    ...
    expect(dispatch.calledWith({ type: actions.increment.type })).to.be.true;
  });
